...
from datasetify.utils import LOGGER
from datasetify.utils.instances import Instances
from datasetify.utils.bboxes import bbox_ioa
from datasetify.utils import segment2box
...
def yolo_v8_transforms(dataset, imgsz, hyp, stretch=False):
    """Convert images to a size suitable for YOLOv8 training."""
    pre_transform = Compose([
        Mosaic(dataset, imgsz=imgsz, p=hyp.mosaic),
        CopyPaste(p=hyp.copy_paste),
